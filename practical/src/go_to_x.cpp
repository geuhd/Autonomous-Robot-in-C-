...
void update_pose(const turtlesim::msg::Pose::SharedPtr currentPose)
{
...
auto subCurrentPose = node->create_subscription<turtlesim::msg::Pose>("turtle1/pose",10,update_pose);
